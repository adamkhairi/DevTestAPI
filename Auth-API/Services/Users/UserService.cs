...
namespace Auth_API.Services.Users
{
    ...
    public class UserService : IUserService
    {
        ...
        public async Task<UserModel> Put(EditUserModel updatedUser)
        {
            ...
            oldUser.Email = Help.Check(oldUser.Email, updatedUser.Email);
            oldUser.FirstName = Help.Check(oldUser.FirstName, updatedUser.FirstName);
            oldUser.LastName = Help.Check(oldUser.LastName, updatedUser.LastName);
            oldUser.UserName = Help.Check(oldUser.UserName, updatedUser.UserName);
            oldUser.PhoneNumber = Help.Check(oldUser.PhoneNumber, updatedUser.PhoneNumber);
            oldUser.Gender = Help.Check(oldUser.Gender, updatedUser.Gender);
            oldUser.Address = Help.Check(oldUser.Address, updatedUser.Address);
            oldUser.Country = Help.Check(oldUser.Country, updatedUser.Country);
            oldUser.State = Help.Check(oldUser.State, updatedUser.State);
            oldUser.City = Help.Check(oldUser.City, updatedUser.City);
            oldUser.ZipCode = Help.Check(oldUser.ZipCode, updatedUser.ZipCode);
